export default [
  {
    id: 1,
    description: `Sempre me perguntam porque escolhi a Odontologia e nunca soube dizer
  ...
  {
    id: 2,
    description: `Hoje tenho meu consultório onde posso atuar da maneira que mais amo, dar
